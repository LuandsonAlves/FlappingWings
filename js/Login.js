...
function play(){
    const url = "http://52.2.64.114:5045/login";
...
function register(){
    const url = "http://52.2.64.114:5045/register";
    let nickname = document.getElementById("nickname").value;
    let password = document.getElementById("password").value;
    let label = document.getElementById("mensagem_de_erro");
    label.innerHTML = "";
...
function join(nickname){
    var playerData = JSON.parse(get('http://52.2.64.114:5045/players/nickname/'+nickname));
